...
export const FolderActions = () => {
  ...
  return (
    <div className="flex justify-center items-center gap-1 z-20 overflow-visible">
      ...
      <Tooltip title={"Eliminar lista"}>
        <Trash className="w-icon h-7 stroke-3 stroke-slate-500 cursor-pointer hover:animate-tada  hover:stroke-red-600 transition-all" />
      </Tooltip>
    </div>
  );
};
